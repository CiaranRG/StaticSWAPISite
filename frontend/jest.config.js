...
export default {
    // This is used for determining how the modules should be transformed before being loaded to the test environment, typically used with bable to add support for node environments but since we are using esModules and not commonJS modules we don't need a transform
    transform: {},
